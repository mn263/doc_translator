...
urlpatterns = patterns(
    ...
    url(r'^api/user-get/username=(?P<username>[a-z0-9-]+)/password=(?P<password>[a-z0-9-]+)$',
        api.UserDetail.as_view()),
    url(r'^api/documents-get/username=(?P<username>[a-z0-9-]+)/password=(?P<password>[a-z0-9-]+)$',
        api.DocumentDetail.as_view()),
